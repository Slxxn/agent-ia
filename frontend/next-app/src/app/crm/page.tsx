...
export default function CRMPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      >
        <div>
          <h1 style={{ fontSize: 22, fontWeight: 700, color: 'var(--text)', letterSpacing: '-0.025em', lineHeight: 1 }}>
      ...
      {loading ? (
        ...
        <motion.div
          ...
          style={{
            ...
            background: 'var(--surface)', border: '1px dashed var(--bd-bright)', borderRadius: 14,
          }}
        >
      ...
      <LaunchProjectModal
        ...
        onLaunched={(id) => router.push(`/project?id=${id}`)}
      />
    </div>
  );
}
